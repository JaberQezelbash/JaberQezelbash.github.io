...
- May 2026: Built a RAG-based multilingual IT support chatbot using Meta Llama-3.1-8B-Instruct as the generator, BGE-M3 for retrieval, BGE reranking, and FAISS vector search. Fine-tuned the generator with QLoRA SFT on Kaggle support-ticket data and evaluated performance using retrieval quality, reranked evidence relevance, lexical F1, ROUGE-L, and generated response quality metrics. (GitHub Repo).
